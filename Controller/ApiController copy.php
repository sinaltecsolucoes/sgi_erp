...
class ApiController
{
    ...
    public function equipeDados()
    {
        $this->checkPermission('apontador', $_POST['funcionario_tipo'] ?? '', $_POST['funcionario_id'] ?? 0);
        $apontadorId = (int)($_POST['apontador_id'] ?? 0);
        ...
        // 2. RETORNA APENAS A LISTA DE EQUIPES
        echo json_encode([
            'success' => true,
            'data' => $equipes  // ← LISTA DIRETA!
        ]);
    }
    ...
    {
        $this->checkPermission('apontador', $_POST['funcionario_tipo'] ?? '', $_POST['funcionario_id'] ?? 0);
        $apontadorId = (int)($_POST['funcionario_id'] ?? 0);
    ...
    public function moverMembro()
    {
        ...
        $origemId = (int)($_POST['equipe_origem_id'] ?? 0);
        $destinoId = (int)($_POST['equipe_destino_id'] ?? 0);
    ...
    public function editarEquipe()
    {
        ...
        $novosMembros = $_POST['novos_membros_ids'] ?? [];
